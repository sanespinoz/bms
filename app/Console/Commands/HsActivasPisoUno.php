...
//Actualizo el grupo
        ...
        \Log::info('Probando hs activas sector A1 GENERAL Piso 1' . \Carbon\Carbon::now() . $gid . ' ' . $pis . ' ' . $canths);
        ...
        for ($i = 2; $i < 5; $i++) {
            ...
            DB::table('grupos')
                ->where('id', $gid)
                ->update(['cant_hs_activo' => $canths]);
            \Log::info('BOX ' . ($i - 1) . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
...
//Actualizo el grupo
        DB::table('grupos')
            ->where('id', $gid)
            ->update(['cant_hs_activo' => $canths]);
        \Log::info('Probando hs activas sector A2 GENERAL Piso 1' . \Carbon\Carbon::now() . $gid . ' ' . $pis . ' ' . $canths);
        ...
        for ($i = 6; $i < 8; $i++) {
            ...
            DB::table('grupos')
                ->where('id', $gid)
                ->update(['cant_hs_activo' => $canths]);
            \Log::info('BOX ' . ($i - 5) . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
...
//Buscar luminarias de ese grupo y actualizar el valor de hs de cada luminaria del g
        ...
        DB::table('grupos')
            ->where('id', $gid)
            ->update(['cant_hs_activo' => $canths]);
        \Log::info('BOX R' . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
...
//Actualizo el grupo
            ...
            DB::table('grupos')
                ->where('id', $gid)
                ->update(['cant_hs_activo' => $canths]);
            \Log::info('L ' . ($i - 9) . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
        }
...
//Actualizo el grupo
            ...
            DB::table('grupos')
                ->where('id', $gid)
                ->update(['cant_hs_activo' => $canths]);
            \Log::info('L ' . ($i - 13) . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
        }
...
//Actualizo el grupo
            ...
            DB::table('grupos')
                ->where('id', $gid)
                ->update(['cant_hs_activo' => $canths]);
            \Log::info('L ' . ($i - 17) . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
        }
...
//Actualizo el grupo
            ...
            DB::table('grupos')
                ->where('id', $gid)
                ->update(['cant_hs_activo' => $canths]);
            \Log::info('L ' . ($i - 21) . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
        }
...
//Actualizo el grupo
            ...
            DB::table('grupos')
                ->where('id', $gid)
                ->update(['cant_hs_activo' => $canths]);
            \Log::info('L ' . ($i - 25) . 'Piso 1' . \Carbon\Carbon::now() . ' ' . $gid . ' ' . $pis . ' ' . $se . ' ' . $canths);
        }
