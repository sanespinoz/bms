...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawCurveTypes() {
              ...
              var options = {
                  title: 'Tendencia histórica de Consumo energético para todo Edificio en la actualidad',
                  width:700,
                  height:500, 
                  hAxis: {
                  title: 'Meses',
     ...
     google.charts.load('current', {'packages':['table']});
         ...
         @endforeach
          @else "No se registran datos para su búsqueda"
            ...
            tab_datos.draw(data, {showRowNumber: true, align:'center', width: '60%', height: '70%'});
          }                         
        </script>
    ...
    <body>
        <div align="center" class="container" id="testing" style="width: 700px;
  margin: 0 auto; ">
            <h2 align="center" id= "titulo">
